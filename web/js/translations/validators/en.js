...
t.add("craueFormFlow.previousStepInvalid", "The form for step %stepNumber% is invalid. Please go back and try to submit it again.", "validators", "en");
t.add("craueFormFlow.flowExpired", "This form has expired. Please submit it again.", "validators", "en");
})(Translator);
