...
class InfoColl_157Type extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $builder
            ->add('r1571', PurifiedNumberType::class, array(
                'label' => false,
                'required' => false,
                'attr' => array(
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Bilan_Social\Bundle\ApaBundle\Entity\InfoColl_157'
        ));
    }
    ...
    public function getBlockPrefix() {
        return 'bilan_social_bundle_apabundle_infocoll_157';
    }
