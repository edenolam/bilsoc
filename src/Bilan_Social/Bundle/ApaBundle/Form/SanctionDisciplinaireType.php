...
class SanctionDisciplinaireType extends AbstractType {
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Bilan_Social\Bundle\ApaBundle\Entity\SanctionDisciplinaire'
        ));
    }
    ...
    public function getBlockPrefix() {
        return 'bilan_social_bundle_apabundle_sanctionDisciplinaire';
    }
