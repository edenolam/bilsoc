...
class SanctionDisciplinaireStagiaireType extends AbstractType {
            ...
            ->add('RefSanctionDisciplinaire', EntityType::class, array(
                ...
                'query_builder' => function (EntityRepository $er) {
                    return $er->createQueryBuilder('u')
                        ...
                        ->andWhere('u.bl614G5 = :bl614G5')
                        ->setParameter('blVali', '0')
                        ->setParameter('bl614G5', '1')
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Bilan_Social\Bundle\ApaBundle\Entity\SanctionDisciplinaireStagiaire'
        ));
    }
    ...
    public function getBlockPrefix() {
        return 'bilan_social_bundle_apabundle_sanctionDisciplinaireStagiaire';
    }
