...
class BscRassctPredictionsAutresMesures {

    /**
     * @var integer
     */
    private $idPredictionsAutresMesures;
    ...
    function getIdPredictionsAutresMesures() {
        return $this->idPredictionsAutresMesures;
    }
    ...
    function setIdPredictionsAutresMesures($idPredictionsAutresMesures) {
        $this->idPredictionsAutresMesures = $idPredictionsAutresMesures;
    }
