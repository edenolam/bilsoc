...
class BscGpeecPlusNbAgentsParSpeEtAge extends IndBaseEntity{

    /**
     * @var integer
     */
    protected $bscGpeecPlusNbAgentsParSpeEtAge;
    protected $bilanSocialConsolide;
    protected $totalParDomaine;
    ...
    function getBscGpeecPlusNbAgentsParSpeEtAge() {
        return $this->bscGpeecPlusNbAgentsParSpeEtAge;
    }
    ...
    function setBscGpeecPlusNbAgentsParSpeEtAge($bscGpeecPlusNbAgentsParSpeEtAge) {
        $this->bscGpeecPlusNbAgentsParSpeEtAge = $bscGpeecPlusNbAgentsParSpeEtAge;
    }
    ...
    function setRefSpecialite($refSpecialite) {
    ...
    function getTotalParDomaine() {
        return $this->totalParDomaine + $this->rNb1 + $this->rNb2 + $this->rNb3 + $this->rNb4 + $this->rNb5 + $this->rNb6 + $this->rNb7 + $this->rNb8 + $this->rNb9 + $this->rNb10;
    }

    function setTotalParDomaine($totalParDomaine) {
        $this->totalParDomaine = $totalParDomaine;
    }
