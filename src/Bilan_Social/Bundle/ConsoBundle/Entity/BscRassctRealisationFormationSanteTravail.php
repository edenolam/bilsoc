...
class BscRassctRealisationFormationSanteTravail {

    /**
     * @var integer
     */
    private $idRealFormSanteTrav;
    ...
    function getIdRealFormSanteTrav() {
        return $this->idRealFormSanteTrav;
    }

    function setIdRealFormSanteTrav($idRealFormSanteTrav) {
        $this->idRealFormSanteTrav = $idRealFormSanteTrav;
    }
