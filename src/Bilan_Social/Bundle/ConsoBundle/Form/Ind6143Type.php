...
use Bilan_Social\Bundle\ConsoBundle\Entity\Ind6143;
...
class Ind6143Type extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $builder
            ->add('r61431', PurifiedNumberType::class, array(
                'required' => false,
                'attr' => array(
                    'class' => 'positiveInteger',
                    'onChange' => 'changedR6143();changedDetect()',
                )
            ))
            ->add('r61432', PurifiedNumberType::class, array(
                'required' => false,
                'attr' => array(
                    'class' => 'positiveInteger',
                    'onChange' => 'changedR6143();changedDetect()',
