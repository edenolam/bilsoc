...
class BscHanditorialInaptEtReclaTempsCompletsType extends AbstractType {
    ...
    public function configureOptions(OptionsResolver $resolver) {
        $resolver->setDefaults(array(
            'data_class' => BscHanditorialInaptEtReclaTempsComplets::class
        ));
    }
    ...
    public function getBlockPrefix() {
        return 'bscHanditorialInaptEtReclaTempsComplets';
    }
