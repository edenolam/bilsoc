 ...
 */
class BscHanditorialMesureInaptitudesRepository extends AbstractRepository {

    public function getResultsForExport($idsBsc) {
        $qb = $this->_em->createQueryBuilder();
        $qb->select('ref.lbMesureboeth, SUM(bsch.mesureInaptitudeH) AS mesureInaptitudeH, SUM(bsch.mesureInaptitudeF) AS mesureInaptitudeF')
