 ...
 */
class BscGpeecNiveauDiplomeRepository extends AbstractRepository {

    public function getResultsForExport($idsBsc) {
        $qb = $this->_em->createQueryBuilder();
        $qb->select('ref.lbDomaineDiplome, SUM(bsch.nbHommes) AS nbHommes, SUM(bsch.nbFemmes) AS nbFemmes')
